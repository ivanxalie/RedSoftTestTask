...
public class EditDepartment extends JDialog {
    ...
    private String id;
    private DepartmentsEditor depEdit;

    public EditDepartment(Connection con, String name, DepartmentsEditor depEdit) {
        this.con = con;
        this.depEdit = depEdit;
        departmentName.setText(name);
        this.setTitle("Редактировать отдел");

        try {
            ResultSet getId = con.createStatement().executeQuery(
                    "select id, name, phone, email from departments where name='" + name + "'"
            );
            while (getId.next()) {
                this.id = getId.getString("id");
                departmentName.setText(getId.getString("name"));
                phone.setText(getId.getString("phone"));
                email.setText(getId.getString("email"));
            }
        }
        ...
        editButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    try {
                        int sal = Integer.parseInt(phone.getText());
                    ...
                    {
                        error.setText("Поле телефон должно содержать цифры!");
                        error.setVisible(true);
                    }
                }
            }
    ...
    private void editDepartments()
    {
        try {
            con.createStatement().execute(
                    "update departments set name='" + departmentName.getText() + "', phone="
                            + Integer.parseInt(phone.getText())
                            + ", email='" + email.getText() + "' where id=" + id
            );
            depEdit.fillDepartments();
        }
        catch (SQLException ex)
        {
            ex.printStackTrace();
...
//        EditDepartment dialog = new EditDepartment();
//        dialog.pack();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel3.add(departmentName, new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        phone = new JTextField();
        panel3.add(phone, new com.intellij.uiDesigner.core.GridConstraints(1, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        error = new JLabel();
        error.setText("Label");
        ...
        panel3.add(email, new com.intellij.uiDesigner.core.GridConstraints(2, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
    }
